      ...
      <div className="flex-4 conteudo-area-cliente">
        ...
        <div className="form-dados">
          ...
          <FormSimples
            ...
            onChange={() => this.onChange('senhaAntiga', e.target.value)}
            label="Senha Atual"
            name="senhaAntiga"
            type="password"
          ...
          <FormSimples
            ...
            onChange={() => this.onChange('novaSenha', e.target.value)}
            label="Nova Senha"
            name="novaSenha"
            type="password"
          ...
          <FormSimples
            ...
            onChange={() => this.onChange('confirmarNovaSenha', e.target.value)}
